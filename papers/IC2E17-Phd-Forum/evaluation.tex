...
\begin{figure}[t!]
  \centering
  \includegraphics[scale=0.6]{images/tput_upload_4-datas-1-worker.pdf}
...
\begin{figure}[t!]
  \centering
  \includegraphics[scale=0.45]{images/avg_stdev_4_streams}
  \caption{Scalability: processing time, average and standard deviation. The experiment is repeated 20 times.}
  \label{fig:scalability}
\end{figure}
\begin{figure}[t!]
  \centering
  \includegraphics[scale=0.6]{images/tput_upload_4-datas-2-workers.pdf}
  ...
  \vspace{0.5cm}
  \includegraphics[scale=0.6]{images/tput_upload_4-datas-4-workers.pdf}
