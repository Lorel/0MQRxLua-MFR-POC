...
Listing \ref{pipeline-example} shows a simple example of a \rxl program to compute the average age of a population by chaining \texttt{:map}, \texttt{:filter} and \texttt{:reduce} functions.
