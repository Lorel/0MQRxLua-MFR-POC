...
\author{
\IEEEauthorblockN{Aurelien Havet\IEEEauthorrefmark{1}, Valerio Schiavoni\IEEEauthorrefmark{1}}
...
Our initial performance results of the \SYS prototype are promising: the framework is easy to use, to program, and it is fast, allowing developers to implement complete processing pipelines in few lines of scripting code.
\end{abstract}
