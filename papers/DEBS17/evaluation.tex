...
In each case, the setup of the pipeline architecture, \emph{i.e.} the creation of the set of containers, has been done in $11$\,s for the lightest configuration, in $15$\,s for the heaviest one.
