...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|}
    \hline
               &parameter  &memory peak  \\
    \hline
dhrystone      &50K        &275KB        \\
               &5M         &275KB        \\
    \hline
fannkuchredux  &10         &28KB         \\
               &11         &28KB         \\
    \hline
nbody          &2.5M       &38KB         \\
               &25M        &38KB         \\
...
binarytrees    &14         &25MB         \\
    ...
    \hline
    \end{tabular}
    \caption{\label{tab:codesize}Parameters and memory usage for Lua benchmarks}
\end{table}

Planned benchmarks:
\begin{itemize}
	\item overhead of the Lua benchmarks from \url{https://github.com/ltratt/vms_experiment/tree/master/benchmarks}. From that set of benchmarks, we did not run fasta, knucleotide, mandelbrot, regexdna and revcomp due to depencies on input files.
\end{itemize}
