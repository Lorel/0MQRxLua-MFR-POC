...
Planned benchmarks:
\begin{itemize}
	\item cost of entering/exiting the enclave from Lua without data
	\item cost of entering/exiting the enclave with increasingly bigger datas (up to the point where we hit the well-known memory issues)
