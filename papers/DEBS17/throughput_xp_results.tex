...
\end{tabular}
\caption{Throughput comparison between normal processing (with clear text data and no encryption), encrypted data but without enclaves, and with encrypted data and SGX processing. We scale the number of worker nodes per stage from one (left-most column), two (center colum) and four (right-most column).}
