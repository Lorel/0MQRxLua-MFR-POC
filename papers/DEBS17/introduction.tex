...
\SYS{} adopts a message-oriented~\cite{mom}, responsive, resilient-to-faults middleware design.\vs{if we mention fault-resilient, we need to show this in the eval somehow}
